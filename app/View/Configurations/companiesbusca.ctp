...
$(document).ready(function() {  
	...
	<?php echo "<div style=\"padding:10px; background:rgba(0,0,0,0.3); \" id=\"boxej2$idbox\">" ?><font color="#fff"><h1><?php echo $info['Company']['nome']; ?></h1></font></div>
	<?php 
