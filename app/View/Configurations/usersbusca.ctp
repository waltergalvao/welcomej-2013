...
<?php foreach ($resultado as $type) { ?>
	<?php $idbox = $idbox + 1; ?>
	<div style="box-shadow:0px 0px 15px rgba(0,0,0,0.1), inset 0px 0px 25px rgba(0,0,0,0.15); padding:5px; background:#fff; font-size:15px; margin-top:5px;">
...
<script type="text/javascript">
 ...
 <div id="tabs" style="overflow:hidden;">
				<ul>
					<li><a href="#tabs-1">Endereço</a></li>
					<li><a href="#tabs-2">Informações de Contato</a></li>
					<li><a href="#tabs-3">Informações Gerais</a></li>
				</ul>
				<div id="tabs-1">
				...
				<h3>Dados do usuário</h3>
					...
					<div style="padding:5px 0 5px 0;"><?php if ($type['User']['presenca']) { ?> <div class="greenishBtn button_small">Presença Confirmada</div><?php } else { ?> <div class="redishBtn button_small">Presença Não Confirmada</div><?php } ?></div>
				</div>
</div>
    </div>
