 ...
 */
	public function display() {
		...
		if ($page == 'home') $this->layout = 'entrada';
		if ($this->Session->read('usuarioID') != '' || $this->Session->read('usuarioPass') != '' || $this->Session->read('usuarioCPF') != ''|| $this->Session->read('usuarioCargo') != '') {
